...
import { ArrowRight, BarChart3, Brain, LayoutDashboard, Menu } from "lucide-react"
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-6 md:px-12 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Link href="/forms/intake" className="px-4 py-2 rounded-md bg-primary text-white text-sm hover:bg-primary/90 transition-colors">
                Get Started
              </Link>
            </div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#6EE7B7]/10 via-white to-[#FCD34D]/10 py-16">
        ...
        <div className="relative container mx-auto px-6 md:px-12 text-center">
          ...
          <Link href="/forms/intake" className="mt-8 inline-block bg-green-800 hover:bg-green-700 text-white px-8 py-4 rounded-md text-lg font-semibold transition-all duration-300 hover:shadow-lg">
